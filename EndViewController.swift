...
class EndViewController: UIViewController, TWTRComposerViewControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        //CHECKS HIGHSCORE FROM PAST GAMES
        updateHighScore()
    ...
    @IBAction func orangeShareButton(_ sender: UIButton) {
        takeScreenshot()
