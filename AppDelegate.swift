...
class AppDelegate: UIResponder, UIApplicationDelegate,TWTRComposerViewControllerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        TWTRTwitter.sharedInstance().start(withConsumerKey:"KAHgMRbEgksj8OxExyidwNnDr", consumerSecret:"J5OLnJtLX9aSQEdXw23lGkypPcCho13VkUNJHh8rIphsYscDJT")
