...
class EndViewControllerUnlimitediPad: UIViewController, TWTRComposerViewControllerDelegate{
    ...
    @IBAction func Credits(_ sender: Any) {
        let vc = UIStoryboard(name: "iPadMain", bundle: nil).instantiateViewController(withIdentifier: "CreditsScreeniPad")as! CreditsiPad
        self.present(vc, animated: false, completion: nil)
    }
